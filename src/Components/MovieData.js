...
const MovieData = [
  { id: Math.random(), myImage: Regard, myImage1: Regard1, myImage2: Regard2, title: "Look at me ", Rating: 3 },
  { id: Math.random(), myImage: Ason, myImage1: Ason1, myImage2: Ason2, title: " A Son", Rating: 5},
  { id: Math.random(), myImage: Zeineb, myImage1: Zeineb2,  myImage2: Zeineb2, title: "Zeineb & snow", Rating: 3 },
  { id: Math.random(), myImage: Fleur, myImage1: Fleur1, myImage2: Fleur2, title: "Fleur d'alep",Rating: 2 },
  { id: Math.random(), myImage: Millefeuille, myImage1: Millefeuille1, myImage2: Millefeuille2, title: "Millefeuille", Rating: 2, },
  { id: Math.random(), myImage: Dachra, myImage1: Dachra1, myImage2: Dachra2, title: "Dachra",Rating: 4 }
]
